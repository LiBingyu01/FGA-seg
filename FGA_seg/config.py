...
def add_FGA_seg_config(cfg):
    ...
    cfg.MODEL.SEM_SEG_HEAD.DECODER_MOD = "fast"
    cfg.MODEL.SEM_SEG_HEAD.FUSION_MOD = "cat"
    cfg.MODEL.SEM_SEG_HEAD.LAMBDA_AUXI = 0.2
    cfg.MODEL.SEM_SEG_HEAD.LAMBDA_ALIGN = 0.02
    cfg.MODEL.SEM_SEG_HEAD.P2T_LAYER = 1
    cfg.MODEL.SEM_SEG_HEAD.KERNEL_SIZE = 3