...
from ..transformer.FGA_seg_predictor import FGA_seg_Predictor


@SEM_SEG_HEADS_REGISTRY.register()
class FGASegHead(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            ignore_value: FGAegory id to be ignored during training.
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        return {
            ...
            "transformer_predictor": FGA_seg_Predictor(
                cfg,
            ),
        }
